...
function Education(props) {
    return (
        <div className="container text-left">
            ...
            <br></br>Degree and Field: Master of Science, MS - Information Systems and Technology 2021-2023
            ...
            <strong>   <FontAwesomeIcon icon={faGraduationCap} /> &nbsp; Andrews University  &nbsp; &nbsp;
                <FontAwesomeIcon icon={faSearchLocation} /> &nbsp;MI, USA</strong>
            <br></br>Degree and Field: Master of Business Administration, MBA 2018-2019
            ...
            <br></br>Degree and Field: Bachelor of Science, BS - Computer Science
